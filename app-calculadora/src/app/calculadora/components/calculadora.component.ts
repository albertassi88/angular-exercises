...
import { CalculadoraService } from '../services/calculadora.service';  //Inserindo o Service
...
export class CalculadoraComponent implements OnInit {
  ...
  constructor(private calculadoraService: CalculadoraService) { }    //Inserindo o Service
   ...
   * Caso já possua uma opercação selecionada, executa a
   ...
   * @return string
   */
  get display(): string {  //get - convensão que cria o display para ser usado em outros lugares
